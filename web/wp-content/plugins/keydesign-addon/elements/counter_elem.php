...
if (!class_exists('KD_ELEM_COUNTER')) {
    ...
    class KD_ELEM_COUNTER extends KEYDESIGN_ADDON_CLASS {
        ...
        public function kd_counter_shrt($atts, $content = null)
        {
            ...
            // Declare empty vars
            $output = $content_icon = $counter_id = $kd_counter_img_array = $js = $icon_color_style = $icon_size_style = $animation_delay = '';
            ...
            if( $count_icon_type == 'icon_browser' && !empty($count_icon) ) {
      				$content_icon = '<div class="kd-counter-icon"><i class="'.$count_icon.' fa" style="'.$icon_size_style.' '.$icon_color_style.'"></i></div>';
