        ...
        class ReduxFramework {
            ...
            public function __construct( $sections = array(), $args = array(), $extra_tabs = array() ) {
                ...
                if ( empty( $this->args['menu_title'] ) ) {
                    $this->args['menu_title'] = __( 'Options', 'intact' );
                }

                if ( empty( $this->args['page_title'] ) ) {
                    $this->args['page_title'] = __( 'Options', 'intact' );
                }
...
//                    }
            ...
            private function _internationalization() {
                 ...
                 */
                $locale = apply_filters( "redux/textdomain/{$this->args['opt_name']}", get_locale(), 'intact' );
            ...
            public function _enqueue() {
                 ...
                 */
                $save_pending = apply_filters( "redux/{$this->args['opt_name']}/localize/save_pending", __( 'You have changes that are not saved. Would you like to save them now?', 'intact' ) );
                 ...
                 */
                $reset_all = apply_filters( "redux/{$this->args['opt_name']}/localize/reset", __( 'Are you sure? Resetting will lose all custom values.', 'intact' ) );
                 ...
                 */
                $reset_section = apply_filters( "redux/{$this->args['opt_name']}/localize/reset_section", __( 'Are you sure? Resetting will lose all custom values in this section.', 'intact' ) );
                 ...
                 */
                $preset_confirm = apply_filters( "redux/{$this->args['opt_name']}/localize/preset", __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'intact' ) );
                ...
                $this->localize_data['args'] = array(
                    ...
                    'please_wait'           => __( 'Please Wait', 'intact' ),
            ...
            public function _load_page() {
                ...
                if ( true == $this->show_hints ) {
                    ...
                    $tab = array(
                        'id'      => 'redux-hint-tab',
                        'title'   => __( 'Hints', 'intact' ),
                        'content' => __( '<p></p>', 'intact' )
                    );
            ...
            private function get_default_output_string( $field ) {
                ...
                if ( ! empty( $default_output ) ) {
                    $default_output = __( 'Default', 'intact' ) . ": " . substr( $default_output, 0, - 2 );
                }
...
//                            }
            ...
            public function _options_page_html() {
                ...
                // Do we support JS?
                echo '<noscript><div class="no-js">' . __( 'Warning- This options panel will not work properly without javascript!', 'intact' ) . '</div></noscript>';
                ...
                if ( ! empty( $this->args['display_name'] ) ) {
                    ...
                    if ( isset( $this->args['dev_mode'] ) && $this->args['dev_mode'] ) {
                        echo '<span class="redux-dev-mode-notice">' . __( 'Developer Mode Enabled', 'intact' ) . '</span>';
                    }
                ...
                echo '<a href="javascript:void(0);" class="expand_options' . $expanded . '">' . __( 'Expand', 'intact' ) . '</a>';
                echo '<div class="redux-action_bar">';
                submit_button( __( 'Save Changes', 'intact' ), 'primary', 'redux_save', false );

                if ( false === $this->args['hide_reset'] ) {
                    echo '&nbsp;';
                    submit_button( __( 'Reset Section', 'intact' ), 'secondary', $this->args['opt_name'] . '[defaults-section]', false );
                    echo '&nbsp;';
                    submit_button( __( 'Reset All', 'intact' ), 'secondary', $this->args['opt_name'] . '[defaults]', false );
                }

                echo '</div>';

                echo '<div class="redux-ajax-loading" alt="' . __( 'Working...', 'intact' ) . '">&nbsp;</div>';
                echo '<div class="clear"></div>';
                echo '</div>';
                ...
                if ( isset( $this->transients['last_save_mode'] ) ) {
                    ...
                    if ( $this->transients['last_save_mode'] == "import" ) {
                         ...
                         */
                        echo '<div class="admin-notice notice-blue saved_notice"><strong>' . apply_filters( "redux-imported-text-{$this->args['opt_name']}", __( 'Settings Imported!', 'intact' ) ) . '</strong></div>';
                        //exit();
                         ...
                         * @param string  translated "settings imported" text
                         */
                        echo '<div class="saved_notice admin-notice notice-yellow"><strong>' . apply_filters( "redux-defaults-text-{$this->args['opt_name']}", __( 'All Defaults Restored!', 'intact' ) ) . '</strong></div>';
                         ...
                         * @param string  translated "settings imported" text
                         */
                        echo '<div class="saved_notice admin-notice notice-yellow"><strong>' . apply_filters( "redux-defaults-section-text-{$this->args['opt_name']}", __( 'Section Defaults Restored!', 'intact' ) ) . '</strong></div>';
                    } else {
                        /**
                         ...
                         */
                        echo '<div class="saved_notice admin-notice notice-green"><strong>' . apply_filters( "redux-saved-text-{$this->args['opt_name']}", __( 'Settings Saved!', 'intact' ) ) . '</strong></div>';
                    }
                 ...
                 */
                echo '<div class="redux-save-warn notice-yellow"><strong>' . apply_filters( "redux-changed-text-{$this->args['opt_name']}", __( 'Settings have changed, you should save them!', 'intact' ) ) . '</strong></div>';
                ...
                echo '<div class="redux-field-errors notice-red"><strong><span></span> ' . __( 'error(s) were found!', 'intact' ) . '</strong></div>';
                ...
                echo '<div class="redux-field-warnings notice-yellow"><strong><span></span> ' . __( 'warning(s) were found!', 'intact' ) . '</strong></div>';
                ...
                if ( $this->args['system_info'] === true ) {
                    ...
                    echo '<a href="javascript:void(0);" id="system_info_default_section_group_li_a" class="redux-group-tab-link-a custom-tab" data-rel="system_info_default">' . $icon . ' <span class="group_title">' . __( 'System Info', 'intact' ) . '</span></a>';
                    echo '</li>';
                }
                ...
                if ( $this->args['system_info'] === true ) {
                    ...
                    echo '<h3>' . __( 'System Info', 'intact' ) . '</h3>';
