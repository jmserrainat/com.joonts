...
// end get_instance;
            ...
            function tracking_request() {
                ...
                $content = '<h3>' . __( 'Help improve Our Panel', 'intact' ) . '</h3>';
                $content .= '<p>' . __( 'Please helps us improve our panel by allowing us to gather anonymous usage stats so we know which configurations, plugins and themes to test to ensure compatibility.', 'intact' ) . '</p>';
                $opt_arr = array(
                    'content'  => $content,
                    'position' => array( 'edge' => 'top', 'align' => 'center' )
                );
                $button2 = __( 'Allow tracking', 'intact' );

                $function2 = 'redux_store_answer("yes","' . $nonce . '")';
                $function1 = 'redux_store_answer("no","' . $nonce . '")';

                $this->print_scripts( $id, $opt_arr, __( 'Do not allow tracking', 'intact' ), $button2, $function2, $function1 );
            }
            ...
            function newsletter_request() {
                ...
                $this->print_scripts( $id, $opt_arr, __( 'Close', 'intact' ), false, '', $function1 );
            }
