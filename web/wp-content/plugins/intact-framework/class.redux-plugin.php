    ...
    if ( ! class_exists( 'ReduxFrameworkPlugin' ) ) {
        ...
        class ReduxFrameworkPlugin {
            ...
            private static function single_activate() {
                ...
                $notices[] = __( 'Redux Framework has an embedded demo.', 'intact' ) . ' <a href="./plugins.php?ReduxFrameworkPlugin=demo">' . __( 'Click here to activate the sample config file.', 'intact' ) . '</a>';
            ...
            public function add_action_links( $links ) {
                ...
                /**
                 * return array_merge(
                 *      array( 'redux_plugin_settings' => '<a href="' . admin_url( 'plugins.php?page=' . 'redux_plugin_settings' ) . '">' . __( 'Settings', 'intact' ) . '</a>' ),
                 *      $links
                 * );
                 */
            }
                ...
                if ( strpos( $file, 'redux-framework.php' ) !== false && is_plugin_active( $file ) ) {
                    ...
                    if ( ( is_multisite() && $this->plugin_network_activated ) || ! is_network_admin() || ! is_multisite() ) {
                        if ( $this->options['demo'] ) {
                            $new_links[3] .= '<br /><span style="display: block; padding-top: 6px;"><a href="./plugins.php?ReduxFrameworkPlugin=demo" style="color: #bc0b0b;">' . __( 'Deactivate Demo Mode', 'intact' ) . '</a></span>';
                        } else {
                            $new_links[3] .= '<br /><span style="display: block; padding-top: 6px;"><a href="./plugins.php?ReduxFrameworkPlugin=demo" style="color: #bc0b0b;">' . __( 'Activate Demo Mode', 'intact' ) . '</a></span>';
                        }
                    }
